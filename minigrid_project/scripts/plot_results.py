...
def main() -> None:
    ...
    parser.add_argument("--comparison-json", type=str, default="results/logs/doorkey_baseline/comparison.json")
    parser.add_argument("--output", type=str, default="results/logs/doorkey_baseline/comparison.png")
